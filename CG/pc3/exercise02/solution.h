...
public:
  ...
  void printCube(vector<double> const &vertices) {
    ...
    vector<vector<int>> faces = {
        {2, 1, 0}, {3, 2, 0}, {4, 5, 6}, {4, 6, 7}, {0, 1, 5}, {0, 5, 4}, {2, 3, 7}, {2, 7, 6}, {7, 3, 0}, {4, 7, 0}, {1, 2, 6}, {1, 6, 5}};
...
void cube_with_triangular_faces(double min_x, double max_x, double min_y, double max_y, double min_z, double max_z, string const &full_path_output_file) {
